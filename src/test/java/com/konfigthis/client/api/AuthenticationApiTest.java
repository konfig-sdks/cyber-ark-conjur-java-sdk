...
public class AuthenticationApiTest {
     ...
     */
    @Test
    public void authenticateWithIdTest() throws ApiException {
        String account = null;
        String id = null;
        String serviceId = null;
        String xRequestId = null;
        api.authenticateWithId(account, id, serviceId)
     ...
     */
    @Test
    public void azureAuthenticateTest() throws ApiException {
        String serviceId = null;
        String account = null;
        ...
        String jwt = null;
        api.azureAuthenticate(serviceId, account, login)
                .xRequestId(xRequestId)
    ...
    public void changeUserPasswordTest() throws ApiException {
        String account = null;
        String xRequestId = null;
        api.changeUserPassword(account)
                .xRequestId(xRequestId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void exchangeLdapCredentialsForApiKeyTest() throws ApiException {
        String serviceId = null;
        String account = null;
        String xRequestId = null;
        api.exchangeLdapCredentialsForApiKey(serviceId, account)
                .xRequestId(xRequestId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void gcpAuthnAuthenticateTest() throws ApiException {
        String account = null;
        String xRequestId = null;
        String acceptEncoding = null;
        String jwt = null;
        api.gcpAuthnAuthenticate(account)
                .xRequestId(xRequestId)
                .acceptEncoding(acceptEncoding)
                .jwt(jwt)
                .execute();
     ...
     */
    @Test
    public void getShortLivedTokenTest() throws ApiException {
        String serviceId = null;
        String account = null;
        ERRORUNKNOWN login = null;
        String xRequestId = null;
        String acceptEncoding = null;
        api.getShortLivedToken(serviceId, account, login)
                .xRequestId(xRequestId)
                .acceptEncoding(acceptEncoding)
                .execute();
        // TODO: test validations
    ...
    public void getUserApiKeyTest() throws ApiException {
        String account = null;
        String xRequestId = null;
        Object response = api.getUserApiKey(account)
                .xRequestId(xRequestId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void jwtAuthenticateTest() throws ApiException {
        String account = null;
        String serviceId = null;
        String xRequestId = null;
        String jwt = null;
        api.jwtAuthenticate(account, serviceId)
                .xRequestId(xRequestId)
                .jwt(jwt)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void kubernetesAuthnAuthenticateTest() throws ApiException {
        String serviceId = null;
        String account = null;
        ERRORUNKNOWN login = null;
        String xRequestId = null;
        String acceptEncoding = null;
        api.kubernetesAuthnAuthenticate(serviceId, account, login)
                .xRequestId(xRequestId)
                .acceptEncoding(acceptEncoding)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void ldapAuthenticateTest() throws ApiException {
        String serviceId = null;
        String account = null;
        ERRORUNKNOWN login = null;
        String xRequestId = null;
        String acceptEncoding = null;
        api.ldapAuthenticate(serviceId, account, login)
                .xRequestId(xRequestId)
                .acceptEncoding(acceptEncoding)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void obtainAccessTokenTest() throws ApiException {
        String account = null;
        String login = null;
        String xRequestId = null;
        String acceptEncoding = null;
        String response = api.obtainAccessToken(account, login)
                .xRequestId(xRequestId)
                .acceptEncoding(acceptEncoding)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void oidcAuthenticateTest() throws ApiException {
        String serviceId = null;
        String account = null;
        String xRequestId = null;
        String idToken = null;
        api.oidcAuthenticate(serviceId, account)
                .xRequestId(xRequestId)
                .idToken(idToken)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void sendCsrForClientCertInjectionTest() throws ApiException {
        String serviceId = null;
        String xRequestId = null;
        String hostIdPrefix = null;
        api.sendCsrForClientCertInjection(serviceId)
                .xRequestId(xRequestId)
     ...
     */
    @Test
    public void toggleAuthenticatorInstanceStatusTest() throws ApiException {
        ERRORUNKNOWN authenticator = null;
        String serviceId = null;
        String account = null;
        String xRequestId = null;
        api.toggleAuthenticatorInstanceStatus(authenticator, serviceId, account)
                .xRequestId(xRequestId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void toggleAuthenticatorStatusTest() throws ApiException {
        String authenticator = null;
        String account = null;
        String xRequestId = null;
        Boolean enabled = null;
        api.toggleAuthenticatorStatus(authenticator, account)
                .xRequestId(xRequestId)
                .enabled(enabled)
                .execute();
        // TODO: test validations
