...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.conjurAuth != null) {
                this.setConjurAuth(configuration.conjurAuth);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getConjurAuth() {
        return ((ApiKeyAuth) this.getAuthentication("conjurAuth")).getApiKey();
    }

    public void setConjurAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("conjurAuth")).setApiKey(apiKey);
    }

    public void setConjurAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("conjurAuth")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/5.3.1/java");
